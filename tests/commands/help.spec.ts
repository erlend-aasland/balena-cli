...
Primary commands:
    ...
    join [deviceIpOrHostname]               promote a local device running balenaOS to join an application on a balena server
    leave [deviceIpOrHostname]              detach a local device from its balena application
